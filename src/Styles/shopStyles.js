export const styles = {
    leftmenu: 'flex justify-left items-center absolute pl-12 w-[10%] h-screen bg-white z-20',
    filter: 'mt-2 mr-6 text-xs cursor-pointer',
    header: 'flex w-full h-fit justify-between mt-0',
    icon: 'w-24 h-24 mb-12 mx-auto text-black',
    body: 'flex flex-wrap justify-center mt-12 z-30 mx-48',
    ...
    openedcard: 'flex justify-center mt-20 z-30 mx-[200px]',
